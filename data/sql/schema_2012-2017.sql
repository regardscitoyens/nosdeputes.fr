...
--
-- Base de données: `nosdeputes_2012`
--
...
CREATE TABLE IF NOT EXISTS `alerte` (
  ...
  `next_mail` datetime DEFAULT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=25114 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1705 ;
...
CREATE TABLE IF NOT EXISTS `amendement` (
  ...
  `sous_amendement_de` varchar(16) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `nb_multiples` bigint(20) DEFAULT '1',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=166023 ;
...
CREATE TABLE IF NOT EXISTS `citoyen` (
  ...
  KEY `role_idx` (`role`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=8767 ;
...
CREATE TABLE IF NOT EXISTS `commentaire` (
  ...
  KEY `citoyen_id_idx` (`citoyen_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=7727 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=94937 ;
...
CREATE TABLE IF NOT EXISTS `intervention` (
  ...
  `intervention` mediumtext COLLATE utf8_unicode_ci,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1107326 ;
...
CREATE TABLE IF NOT EXISTS `organisme` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `nom` varchar(333) COLLATE utf8_unicode_ci DEFAULT NULL,
  `type` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `slug` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1151 ;
...
CREATE TABLE IF NOT EXISTS `parlementaire` (
  ...
  `parti` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `url_ancien_cpc` text COLLATE utf8_unicode_ci,
  `url_nouveau_cpc` text COLLATE utf8_unicode_ci,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `slug` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1381965 ;
...
CREATE TABLE IF NOT EXISTS `parlementaire_texteloi` (
  ...
  KEY `parlementaire_id_idx` (`parlementaire_id`),
  KEY `texteloi_id_idx` (`texteloi_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=66316 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=5817 ;
...
CREATE TABLE IF NOT EXISTS `presence` (
  ...
  KEY `parlementaire_id_idx` (`parlementaire_id`),
  KEY `seance_id_idx` (`seance_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=197116 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=349911 ;
...
CREATE TABLE IF NOT EXISTS `question_ecrite` (
  ...
  KEY `parlementaire_id_idx` (`parlementaire_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=104144 ;
...
CREATE TABLE IF NOT EXISTS `section` (
  ...
  UNIQUE KEY `md5` (`md5`),
  KEY `section_id_idx` (`section_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=18717 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=32860 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4065205 ;
...
CREATE TABLE IF NOT EXISTS `titre_loi` (
  ...
  `nb_commentaires` bigint(20) DEFAULT NULL,
  `texteloi_id` varchar(16) COLLATE utf8_unicode_ci DEFAULT NULL,
  `leveltype` varchar(16) COLLATE utf8_unicode_ci DEFAULT NULL,
  `level1` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
  `level2` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
  `level3` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
  `level4` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
  `titre` text COLLATE utf8_unicode_ci,
  `expose` text COLLATE utf8_unicode_ci,
  `parlementaire_id` bigint(20) DEFAULT NULL,
  `date` date DEFAULT NULL,
