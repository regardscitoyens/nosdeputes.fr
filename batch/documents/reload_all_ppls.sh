...
curl -sL "http://www2.assemblee-nationale.fr/documents/liste/(ajax)/1/(limit)/10000/(type)/propositions-loi" | sed 's|14/ta/ta0080/|14/propositions/pion0733/|' | grep "documents/notice/14/pro" all-ppls | sed 's/^.*href="//' | sed 's/"><i.*$//' | sed 's|/documents/notice/14/propositions/pion\([0-9]\+\)/(index)/propositions-loi|http://www.assemblee-nationale.fr/14/propositions/pion\1.asp|' > all-ppls
