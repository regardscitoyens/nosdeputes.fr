...
prefixes_noms = [
    'M ', 'M.', 'Madame', 'MM.', 'Mme', 'Monsieur', 'Mr', 'Ms', 'Un député', 'Une députée', 'Représentant', 'SEM.', 'Mgr',
    'S.E.M. l’ambassadeur', 'Maréchal', 'Monseigneur', 'Adjudant',  'Amiral', 'Capitaine', 'Caporal', 'CGA ', 'Colonel', 'Commandant', 'Commissaire', 'Cr1 ', 'Dr ', 'Dr. ', 'Général', 'Grand rabbin', 'Ica ', 'Ingénieur en chef', 'Infirmier', 'La policière', 'La présidente', 'Le Président', 'Lieutenant', 'Sergent', 'Son Exc. ', 'Maitre', 'Maître', 'Major', 'Me ', 'Médecin général', 'Plusieurs députés', 'Pr ', 'Pr. ', 'Premier', 'Deuxième', 'Troisième', 'Quatrième', 'Professeur', 'Quartier maître', 'Quatrier-Maitre', 'Une auditrice', 'Vice-amiral', 'Délégué local', 'Chef de ', 'Surveillante de la', 'Ancien chef', 'Ancien surveillant', 'Adjoint au chef', 'Contrôleur général', 'Quartier-maître', 'Brigadier', 'ICA', 'Docteur', 'Père',
    'Mathieu', 'Sally', 'Agnès', 'Alain', 'Alexandre', 'André', 'Brigitte', 'Bruno', 'Cédric', 'Charles', 'Claude', 'Delphine', 'Didier', 'Elisa', 'Emmanuel', 'Fabien', 'Fabrice', 'Francis', 'Frédéric', 'Gilles', 'Gwendal', 'Jacques', 'Jean', 'Julien', 'Laurent', 'Loïc', 'Marc', 'Marie', 'Michèle', 'Nicole', 'Olivier', 'Patrice', 'Pierre', 'Raphaël', 'Rémi', 'Stéphane', 'Thibault', 'Thierry', 'Thomas', 'Ugo ', 'Vincent', 'Yann', 'Yannick', 'Andreea', 'Maxime', 'Claude-Valentin', 'Simon', 'Benoît', 'Christophe', 'Léovanie', 'Amélia', 'Claudine'
]
...
def cleanhtml(s):
    ...
    s = reg_ul.sub('', s)
    reg_li = re.compile(r'<li(?: class="assnatListParagraph")? style=[^>]*>[\s\r\n]*(.*?)[\s\r\n]*</li>')
...
def html2json(s):
    ...
    for p in p_tags:
        ...
        if has_video and (not p.get_text().strip() or ("cr-cloi" in source and "Lien vidéo" in p_str and not "ne font pas l’objet d’un compte rendu" in intervention)):
            has_video = False
