...
prefixes_noms = [
    ...
    'S.E.M. l’ambassadeur', 'Maréchal', 'Monseigneur', 'Adjudant',  'Amiral', 'Capitaine', 'Caporal', 'CGA ', 'Colonel', 'Commandant', 'Commissaire', 'Cr1 ', 'Dr ', 'Dr. ', 'Général', 'Grand rabbin', 'Ica ', 'Ingénieur en chef', 'Infirmier', 'La policière', 'La présidente', 'Le Président', 'Lieutenant', 'Sergent', 'Son Exc. ', 'Maitre', 'Maître', 'Major', 'Me ', 'Médecin général', 'Plusieurs députés', 'Pr ', 'Pr. ', 'Premier', 'Professeur', 'Quartier maître', 'Quatrier-Maitre', 'Une auditrice', 'Vice-amiral', 'Délégué local', 'Chef de ', 'Surveillante de la', 'Ancien chef', 'Ancien surveillant', 'Adjoint au chef',
