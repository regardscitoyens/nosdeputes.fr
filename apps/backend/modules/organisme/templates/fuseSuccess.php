...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    ...
    <?php if (isset($doublons) && $doublons > 1) echo '<p style="text-align:center;">ATTENTION : des séances vont faire doublon, veuillez les fusionner avant de fusionner les commissions</p>';
    else {
      echo '<h2 style="text-align:center;">ATTENTION !!! Voulez-vous vraiment faire fusionner ces '.$type.'s';
      if ($type == "commission") echo ' et obtenir le résultat ci-dessous ?</h2><p style="text-align:center;">Veuillez confirmer avec le <a href="#fuse">lien en bas de page</a></p>';
      else echo ' ?</h2>';
    } ?>
