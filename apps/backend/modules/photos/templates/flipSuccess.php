...
foreach ($parlementaires as $parlementaire) if ($parlementaire->slug) { $ct++ ?>
  <div class="photo">
    ...
    echo '<a href="/'.$parlementaire->slug.'" target="_blank"><img title="'.$parlementaire->nom.' -- ('.$groupe.')" src="/senateur/photo/'.$parlementaire->slug.'/100?_sf_ignore_cache=1" class="jstitle photo_fiche" alt="Photo de '.$parlementaire->nom.'"/></a>'; ?>
