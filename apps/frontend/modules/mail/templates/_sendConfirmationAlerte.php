Nous avons reçu une demande d'abonnement pour l'alerte e-mail suivante : « <?php echo $alerte->titre; ?> »

Si vous êtes bien à l'origine de cette demande, merci de confirmer en cliquant sur le lien suivant :

<?php echo rtrim(sfConfig::get('app_base_url'), '/').preg_replace('/symfony\/?/', '', url_for('alerte/confirmation?verif='.$alerte->getVerif())); ?>
