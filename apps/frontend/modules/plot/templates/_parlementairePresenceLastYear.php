...
$DataSet2->SetSerieName("10 000 mots", "Serie5");
...
$Test->drawScale($Data,$DataDescr,SCALE_NORMAL,150,150,150,TRUE,0,0,TRUE,1,TRUE);
$Test->drawGrid(4,TRUE,230,230,230,400);
//$Test->drawTreshold(0,143,55,72,TRUE,TRUE);
$Test->setColorPalette(0,150,150,150);
$Test->drawOverlayBarGraph($Data2,$DataDescr2,60);
