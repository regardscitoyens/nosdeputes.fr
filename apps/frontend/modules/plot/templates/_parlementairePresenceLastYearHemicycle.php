...
for ($i = 1; $i < $n; $i++) {
  $participations[$i] = $n_participations['loi'][$i] + $n_participations['question'][$i];
}
$DataSet = new xsPData();
...
if (isset($fonctions)) {
  $fonction = (int)(3*($fonctions['hemicycle'])/(array_sum($n_participations['loi']+$n_participations['question'])));
