...
<img id="graph_groupes" alt="Répartition de l'activité parlementaire sur l<?php echo myTools::getTextEndDataWithContext(); ?>" src="<?php echo url_for('@groupes_plot_graph?type='.$type).'?mapId='.$PictureID; ?>" onmousemove="getMousePosition(event);" onmouseout="nd();"/>
