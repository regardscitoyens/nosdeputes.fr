...
<h3><?php $n_presences = count($presences); if ($n_presences == 0) echo "Aucune"; else echo $n_presences; echo " activité"; if ($n_presences > 1) echo "s"; if ($type == "commission") echo " enregistrée"; else echo " détectée"; if ($n_presences > 1) echo "s"; ?></h3>
