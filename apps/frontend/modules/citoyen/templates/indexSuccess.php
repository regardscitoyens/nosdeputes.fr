...
<p><?php echo $total; ?> citoyens se sont inscrits sur NosSénateurs.fr depuis l'ouverture du site le 14 septembre 2011. <?php echo $comments['auteurs']; ?> d'entre eux ont laissé un total de <?php echo link_to($comments['comments'].'&nbsp;commentaires', '@commentaires'); ?>.</p>
