...
<tr>
  <td class="orga">
    <a class="<?php echo $o['slug']; if ($type == "groupe") echo ' jstitle" title="'.$o["description"]; ?>" href="<?php echo url_for($type == "groupe" ? '@list_parlementaires_groupe?acro='.$o['acronyme'] : '@list_parlementaires_organisme?slug='. $o["slug"]); ?>">
      <?php if ($type == "groupe")
        echo '<span class="c_'.strtolower($o['acronyme']).'"></span>';
      echo $name; ?>
    </a>
  </td>
...
<?php if ($type == "groupe") {
  ...
  echo include_component('plot', 'groupes', array('plot' => 'groupes', 'groupes' => $organismes));
  echo '</div>';
} ?>
