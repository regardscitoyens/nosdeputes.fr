...
<div class="contenu_depute">
  <?php include_partial('parlementaire/fiche', array('parlementaire'=>$parlementaire, 'commissions_permanentes' => $commissions_permanentes, 'missions' => $missions, 'historique' => $parlementaire->historique)); ?>
