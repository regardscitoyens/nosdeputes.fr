<?php $fin = myTools::isFinLegislature();
  $fresh = myTools::isFreshLegislature();
...
<h2>Activité <?php if ($fin) echo "mensuelle moyenne "; ?>de tous les députés<?php if (!$fin && !$fresh) echo " en cours de mandat depuis au moins 10 mois"; ?> :</h2>
<?php
...
<p class="aligncenter"><small><?php if (!$fin) echo "Ces données portent uniquement sur les douze derniers mois. "; ?>Retrouvez les données historisées mois par mois au travers de <u><a href="https://github.com/regardscitoyens/nosdeputes.fr/blob/master/doc/api.md">l'API de NosDéputés.fr</a></u></small></p>
</div></div>
