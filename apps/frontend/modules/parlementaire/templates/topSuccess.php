...
<p class="aligncenter"><small><?php if (!$fin) echo "Ces données portent uniquement sur les douze derniers mois. "; ?>Retrouvez les données historisées mois par mois au travers de <u><a href="http://cpc.regardscitoyens.org/trac/wiki/API">l'API de NosDéputés.fr</a></u></small></p>
</div></div>
