...
<div class="accueil_message_content">
  ...
  <div class="accueil_message_signature">
	...
	<div class="accueil_senateurs_jour">
...
<div class="clear accueil">
  ...
  <h2><span style="margin-right: 5px;"><img height="19" alt="actu" src="<?php echo $sf_request->getRelativeUrlRoot(); ?>/images/xneth/ico_nossenateurs.png" /></span>Trouver son sénateur</h2>
    <div class="cont_box_news">
	  ...
	  <div class="message">
	  <p>Pour retrouver votre sénateur sur le site, vous pouvez saisir son nom.</p>
	  ...
	  <input size="25" name="search"/><input type="hidden" name="object_name" value="Parlementaire"/><input type="submit" value="Trouver mon sénateur"/>
...
<div class="box_container">
  ...
  <h2><span style="margin-right: 5px;"><img alt="activite" src="<?php echo $sf_request->getRelativeUrlRoot(); ?>/images/xneth/ico_graph.png" /></span><a href="<?php echo url_for('@top_global'); ?>">Activité parlementaire d<?php echo myTools::getTextEndDataWithContext(); ?></a></h2>
