...
if ($parlementaire->slug)
  echo '<img title="'.$parlementaire->nom.' -- ('.$groupe.')" src="'.url_for('@resized_photo_parlementaire?height='.$height.'&slug='.$parlementaire->slug.$add).'" class="jstitle photo_fiche" width="'.round($height*156/200).'" height="'.$height.'" alt="Photo de '.$parlementaire->nom.'"/>';
