...
<div class="table_des_matieres">
  <ul>
    ...
    <ul>
      ...
      <li><a href="#post_4">Dans les graphes des députés et la synthèse, quelle est la différence entre les "présences relevées", les "présences enregistrées" et la "présence médiane" ?</a></li>
...
<div id="faq">
  ...
  <h3 id="post_4">Dans les graphes des députés et la synthèse, quelle est la différence entre les "présences relevées", les "présences enregistrées" et la "présence médiane" ?</h3>
  <p>Si les présences en commission sont enregistrées et diffusées publiquement à tous, les présences en hémicycle ne le sont pas. Pour détecter la présence d'un député en séance d'hémicycle, nous détectons sa participation orale au sein des compte-rendus de séance diffusés. Il est cependant rare que tous les députés présents parlent lors d'une séance et nous ne pouvons donc pas comptabiliser de manière exhaustive les présences des députés en hémicycle. C'est également pour cela que le graphe d'activité globale d'un député indique des présences relevées puisqu'il combine les données des commissions et de l'hémicycle.</p><p>Dans les graphes d'activité, la présence médiane affichée en liseré gris vise à apporter un élément de comparaison entre les différents graphes. Elle indique pour chaque semaine le nombre de séances médian auquel l'ensemble des députés à été relevé présent, c'est-à-dire que la moitié des députés ont été relevés présents à plus de séances que cette valeur pour la semaine correspondante, et la moitié à moins de séances.</p>
  ...
  <p>Le site a été construit et est hébergé entièrement avec des logiciels libres. Notre serveur est une machine GNU/Linux Debian utilisant les services Apache 2 et MySQL. Le site a été développé en PHP grâce à l'environnement de développement <a rel="nofollow" href="http://www.symfony-project.org/">Symfony</a>. Nous utilisons la librairie pChart pour tracer les graphiques, gd pour le traitement d'image et jQuery pour la surcouche javascript. Nous nous efforçons de respecter les standards définis par le W3C. Si vous avez des problèmes d'accessibilité, n'hésitez pas à nous le signaler à contact [at] regardscitoyens.org et nous ferons le maximum pour les corriger rapidement.</p>
</div>
