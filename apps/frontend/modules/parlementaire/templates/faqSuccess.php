...
<div class="table_des_matieres">
  <ul>
    ...
    <ul>
      ...
      <li><a href="#post_4">Dans les graphes des députés et la synthèse, quelle est la différence entre les "présences détectées", les "présences enregistrées" et la "présence médiane" ?</a></li>
