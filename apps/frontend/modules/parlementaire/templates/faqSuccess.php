...
<div class="table_des_matieres">
  <ul>
    <li><a href="#post_0">NosDéputés.fr est-il un site officiel de l'Assemblée nationale ?</a></li>
...
<div id="faq">
  ...
  <p>Toutes les données relatives à l'activité parlementaire présentées sur ce site sont issues du site de l'<a rel="nofollow" href="https://www.assemblee-nationale.fr/">Assemblée nationale</a> et du Journal Officiel. Il s'agit donc d'informations intégralement publiques. Seules les pages web personnelles des députés et leurs profils Facebook et Twitter sont occasionellement complétées humainement sur identification ou signalement.</p>
  <p>Les cartes utilisées sont librement adaptées de celles remises à disposition par Wikipedia, Toxicode et Jérôme Cukier. Vous pouvez les télécharger depuis <a href="https://github.com/regardscitoyens/nosdeputes.fr/blob/master/doc/opendata.md#donn%C3%A9es-compl%C3%A9mentaires">cette page</a>.</p>

  <h3 id="post_3">Avez-vous le droit de publier ces données ?</h3>
  <p>Oui, cela est précisé sur le site de l'<a rel="nofollow" href="https://www.assemblee-nationale.fr/faq.asp">Assemblée nationale</a> sous réserve de conditions parfaitement remplies par NosDéputés.fr&nbsp;:</p>
  <blockquote><i>Les documents « publics » ou « officiels » ne sont couverts par aucun droit d'auteur. Ils peuvent donc être reproduits librement. C'est le cas pour les débats et les documents parlementaires. Les informations utilisées ne doivent l'être qu'à des fins personnelles, associatives ou professionnelles, toute utilisation ou reproduction à des fins commerciales ou publicitaires étant interdite. La reproduction des documents |...] sous forme électronique est autorisée, sous réserve de la gratuité de leur diffusion, du respect de l’intégrité des documents reproduits, de la mention du nom de l’auteur, de la source, et d’un lien renvoyant vers le document original en ligne sur le site.</i></blockquote>
  <p>De plus, la majorité des données collectées pour alimenter NosDéputés.fr sont <a href="https://data.assemblee-nationale.fr/">diffusées par l'Assemblée en Open Data sous Licence Ouverte</a>.</p>

  <h3 id="post_2bis">Vos données sont-elles à jour ?</h3>
  <p>Une mise à jour automatique de NosDéputés.fr est réalisée toutes les 8 heures à partir des sources officielles au Journal Officiel et sur le site de l'Assemblée.</p>
  ...
  <h3 id="post_322">J'ai vu baisser plusieurs des indicateurs d'activité d'un député, comment cela est-il possible ?</h3>
  ...
  <h3 id="post_323">Que signifient les couleurs rouge et vert sur les indicateurs d'activité des députés ?</h3>
  <p>Si un député a exercé son mandat durant au moins dix des douze derniers mois, il est intégré à la <a rel="nofollow" href="/synthese">synthèse globale</a> permettant de comparer l'activité des députés, indicateur par indicateur, sur l'année passée.</p>
  <p>Si un indicateur du député se trouve parmi les 150 plus hautes ou plus basses valeurs de l'ensemble des députés de la synthèse, il apparaît respectivement en vert ou en rouge (gras ou italique pour les daltoniens).</p>
  <p>Cette synthèse et ce code couleur ne s'appliquent pas aux députés dont le mandat est clos ou qui sont en exercice depuis moins de dix mois, comme par exemple les suppléants de députés nommés au gouvernement. Il serait en effet inadéquat de comparer des mesures d'activité sur des périodes incomparables.</p>

  <h3 id="post_10">Proposez-vous un palmarès ou classement général des députés ?</h3>
  <p>Non.</p>
  <p>Si la <a rel="nofollow" href="/synthese">synthèse globale</a> permet d'ordonner les députés indicateur par indicateur, il n'existe pas à notre sens de combinaison de coefficients parfaite qui permettrait d'établir un palmarès général des députés.</p>
  ...
  <p>&nbsp;- la <b>participation aux débats</b> en commission et en hémicycle (identifiée par les prises de parole, même brèves, consignées dans les compte-rendus du site de l'Assemblée ou les scripts des retranscriptions vidéos) ;</p>
  <p>&nbsp;- la <b>participation physique aux scrutins publics</b> en hémicycle sans usage de délégation de vote (uniquement depuis la <a href="https://www2.assemblee-nationale.fr/qui/pour-une-nouvelle-assemblee-nationale-les-rendez-vous-des-reformes-2017-2022/les-reformes-en-cours/publier-en-open-data-la-liste-des-deputes-ayant-pris-part-directement-a-un-vote">mise en place de la publicité des délégations des votes le 20 mars 2018</a>).</p>
  ...
  <p><b>- Participations :</b> un député est compté comme participant à une séance d'hémicycle s'il y a prononcé au moins une "intervention longue", c'est-à-dire comportant plus de 20 mots. Vous pourrez en effet constater comme nous que les très courtes interventions ne peuvent pas aborder le fond du débat.</p>
  <p><b>- Médiane des députés :</b> la présence médiane affichée en liseré gris vise à apporter un élément de comparaison entre les différents graphes. Elle indique pour chaque semaine le nombre de réunions ou séances auxquelles le député médian a été détecté présent, c'est-à-dire qu'au moins un député sur deux a été détecté présent autant de fois cette semaine là.</p>
  <p><b>- Questions orales :</b> sur le graphique global ainsi que sur le graphique de la seule activité en hémicycle, le nombre de questions posées par le député lors de séances de questions au gouvernement ou de questions orales sans débat apparaît sous la forme de barres bleues.</p>
  ...
  <p>Cela arrive !</p>
  <p>Nous avons récemment mis en œuvre les développements nécessaires à l'intégration des données relatives aux scrutins publics à partir de l'OpenData proposée par l'Assemblée nationale afin notamment d'en tirer des informations complémentaire sur la participation des députés aux travaux dans l'hémicycle. Nous n'avons cependant pas encore eu le temps de nous pencher sur la présentation des positions individuelles de chaque député lors de ces scrutins ou l'association de ces scrutins aux textes de lois et amendements correspondants mais tout cela est au <a href="https://github.com/regardscitoyens/nosdeputes.fr/pull/115">programme</a>. Cela pourra également permettre d'évaluer par exemple la fidélité d'un député à son groupe politique.</p>
  <p>Il reste à noter qu'une immense majorité des votes se déroulant à main levée, l'analyse des votes au prisme des seuls scrutins publics enregistrés électroniquement ne peut permettre de rendre compte de l'ensemble des positions d'un député.</p>
  ...
  <p>Nous conseillons aux visiteurs de ce site s'intéressant à l'activité en circonscription de leurs élus de consulter la presse régionale ou les sites/blogs des députés qui peuvent être de bonnes sources d'information.</p>

  <h2 id="post_11">Les responsables du site</h2>

  <h3 id="post_12">Comment peut-on vous contacter ?</h3>
  <p>Vous pouvez écrire à l'ensemble des responsables de l'association <a rel="nofollow" href="https://www.regardscitoyens.org/">Regards Citoyens</a> à notre adresse de contact&nbsp;: contact [at] regardscitoyens.org</p>

  <h3 id="post_13">Êtes-vous affiliés à un parti ou à une organisation politique ?</h3>
  <p>Les activités de <a rel="nofollow" href="https://www.regardscitoyens.org/">Regards Citoyens</a> et du site <a rel="nofollow" href="https://www.nosdeputes.fr/">NosDéputés.fr</a> sont totalement indépendantes de tout parti politique.</p>
  ...
  <p>De plus, la mise en place de "<i>cards</i>" facilite l'intégration du site dans les réseaux sociaux : lorque le site ou une de ses pages y sont mentionnés, le message est automatiquement accompagné d'une capture d'écran de la page citée.</p>

  <h3 id="post_19">Comment puis-je vous aider ?</h3>
  <p>La meilleure manière de nous aider est de vous exprimer dans les commentaires sur les travaux parlementaires et ainsi de contribuer aux débats qui ont lieu sur le site. Si vous le souhaitez, vous pouvez aussi nous aider à populariser le site en en parlant autour de vous. Vous pouvez également <a rel="nofollow" href="https://www.regardscitoyens.org/nous-aider/">nous soutenir financièrement</a>, pour faire face aux coûts de mise en place de ce site. Enfin, si vous avez des idées d'amélioration ou des compétences particulières que vous estimez utiles à notre travail, n'hésitez à nous en faire part également par e-mail !</p>

  <h3 id="post_21">Proposez-vous un suivi par alertes e-mails ?</h3>
  <p>Oui. Depuis la page de chaque député, vous pouvez vous abonner pour recevoir par mail au rythme que vous souhaitez les informations relatives à l'activité de ce parlementaire.</p>
  <p>Nous proposons également un système d'alerte par mots clés depuis le moteur de recherche afin d'être alerté par exemple à chaque fois que les députés évoquent un sujet donné. Pour ce faire, il suffit de cliquer sur l'icône représentant un courriel et d'indiquer votre adresse e-mail.</p>
