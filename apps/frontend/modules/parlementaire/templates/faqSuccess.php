...
<div class="table_des_matieres">
  <ul>
    ...
    <ul>
      ...
      <li><a href="#post_32">À quoi correspondent les nombres indiqués dans la barre « Activité » sur la page de chaque député ?</a></li>
...
<div id="faq">
  ...
  <p>Toutes les données relatives à l'activité parlementaire présentées sur ce site sont issues du site de l'<a rel="nofollow" href="http://www.assemblee-nationale.fr/">Assemblée nationale</a> et du Journal Officiel. Il s'agit donc d'informations intégralement publiques.
  ...
  <p>&nbsp;- la présence aux réunions des commissions (<a href="#post_5">voir ci-dessus</a>) ;</p>
  <p>&nbsp;- la participation aux débats en commission et en hémicycle (identifiées par les prises de parole, même brèves, consignées dans les compte-rendus du site de l'Assemblée ou les scripts des retranscriptions vidéos) ;</p>
  <p>&nbsp;- la participation, sans faire usage de délégation de vote, aux scrutins publics en hémicycle (uniquement depuis la <a href="http://www2.assemblee-nationale.fr/qui/pour-une-nouvelle-assemblee-nationale-les-rendez-vous-des-reformes-2017-2022/les-reformes-en-cours/publier-en-open-data-la-liste-des-deputes-ayant-pris-part-directement-a-un-vote">mise en place de la publicité des délégations des votes le 13 février 2018</a>).</p>
  ...
  <p>Oui&nbsp;! Le code source du site et sa documentation technique sont disponibles sous <a rel="nofollow" href="http://www.gnu.org/licenses/agpl-3.0.html">licence AGPL</a> à l'adresse suivante&nbsp;: <a rel="nofollow" href="https://github.com/regardscitoyens/nosdeputes.fr">https://github.com/regardscitoyens/nosdeputes.fr</a></p><p>N'hésitez pas à <a href="https://github.com/regardscitoyens/nosdeputes.fr/issues/new">nous faire remonter</a> tout bug que vous pourriez rencontrer ou nous proposer des suggestions d'amélioration&nbsp;!</p><p>Et si vous avez des talents de développeur, vous êtes les bienvenus pour nous aider&nbsp;!</p>
