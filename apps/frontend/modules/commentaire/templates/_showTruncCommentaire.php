...
<p><span class="titre_commentaire"><a href="<?php echo $presentation.url_for($c->lien); ?>#commentaire_<?php echo $c->id; ?>"><?php if (isset($presentation)) echo $c->getShortPresentation($presentation); else echo $c->getPresentation().', ';  
