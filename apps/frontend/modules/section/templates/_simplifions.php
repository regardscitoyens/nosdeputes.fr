...
<ul>
<?php $done = array(); foreach($lois as $l) if ($l['texteloi_id'] != "1004" && (!isset($done[$l['Texteloi']['id_dossier_an']]) || preg_match('/^110[89]$/', $l['texteloi_id']))) : $done[$l['Texteloi']['id_dossier_an']] = 1; ?>
