...
?>
    ...
    <?php echo stylesheet_tag($style.'/style.v.3.css'); ?>
...
--></script>
      ...
      <div id="sous_menu">
        ...
        <div id="sous_menu_3" style="display:<?php if ($menu_citoyen) echo 'block'; else echo 'none'; ?>">
	     ...
	     <div style="text-align: center; margin-top: 27px;"><h2><a href="/dossiers/date">Participez aux débats « Simplifions la loi »</a></h2></div>
      </div>
      <div id="corps_page">
