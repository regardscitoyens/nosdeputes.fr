...
rm $CSVDIR/presences_deputes_mercredimatin.csv $CSVDIR/commissions_mercredimatin.csv
...
for month in 10 11 12 01 02 03 04 05 06; do
  ...
  echo $year'-'$month'-01->'$year2'-'$month2'-01 : $CSVDIR/'$year'-'$month'.txt'
