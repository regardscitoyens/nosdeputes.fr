...
CREATE TABLE article_loi (id BIGINT AUTO_INCREMENT, nb_commentaires BIGINT, texteloi_id VARCHAR(8), titre VARCHAR(16), ordre BIGINT, precedent VARCHAR(16), suivant VARCHAR(16), expose TEXT, titre_loi_id BIGINT, slug VARCHAR(255), UNIQUE INDEX iloititre_idx (texteloi_id, titre), INDEX iloiarticle_idx (texteloi_id, ordre), UNIQUE INDEX sluggable_idx (slug), INDEX titre_loi_id_idx (titre_loi_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ENGINE = MyISAM;
CREATE TABLE alinea (id BIGINT AUTO_INCREMENT, nb_commentaires BIGINT, texteloi_id VARCHAR(8), article_loi_id BIGINT, numero BIGINT, texte TEXT, created_at DATETIME, updated_at DATETIME, UNIQUE INDEX iarticleloinumero_idx (texteloi_id, article_loi_id, numero), INDEX article_loi_id_idx (article_loi_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ENGINE = MyISAM;
